...
#     ttk.Label(self.frame_header, style='Header.TLabel', text = "View Plans").grid(row=0, column=1, rowspan=2)
...
#     self.list_s.bind('<<ListboxSelect>>',self.get_selected_customer)
